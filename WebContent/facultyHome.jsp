...
<body>
<div> 
<form name="my-form" onsubmit="return validform()" method="post" action="TakeAttendance.jsp">
...
<button class="btn"><a href="export.jsp"><i class="fa fa-download"></i> Download</a></button>
