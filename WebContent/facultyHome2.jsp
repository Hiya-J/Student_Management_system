...
<body>
<div> 
<form name="my-form" onsubmit="return validform()" method="post" action="TakeAttendance2.jsp">
...
<button class="btn"><a href="export2.jsp"><i class="fa fa-download"></i> Download</a></button>
