...
<body>
	...
	<div class="w3-container">
		<div class="w3-bar w3-black">
			...
			<button class="w3-bar-item w3-button tablink w3-black"
				onclick="openCity(event,'Paris')">Insert New Faculty</button>
			<button class="w3-bar-item w3-button tablink w3-black"
				onclick="openCity(event,'Tokyo')">Registered Students</button>
			<button class="w3-bar-item w3-button tablink w3-black"
				onclick="openCity(event,'Tokyo1')">Registered faculty</button>
	...
	<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
						<div class="card-header">Insert New Faculty</div>
						<div class="card-body">
							<form name="my-form" onsubmit="return validform()"action="AddnewFaculty.jsp" method="post">
								...
								<div class="form-group row">
									<label for="email_address"
										class="col-md-4 col-form-label text-md-right">ContactNo.</label>
									<div class="col-md-6">
								...
								<div class="form-group row">
									<label for="user_name"
										class="col-md-4 col-form-label text-md-right">Experience</label>
									<div class="col-md-6">
		...
		<div class="tbl-content">
			<table cellpadding="0" cellspacing="0" border="0">
                ...
                <%try
                {
                	Connection con= ConnectionProvider.getCon();
                	Statement st= con.createStatement(); 
                	ResultSet rs=st.executeQuery("select *from faculty1");
                	while(rs.next())
                	{
